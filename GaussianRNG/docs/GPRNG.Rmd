...
CDF of a sample of `3000` random draws based on this algorithm. Besides, given 
$P(S<-16)+P(S>16)<2e-57$, the probability that is more extreme than the lower 
and upper limits `0` and `256` is so small that the approximation can be considered being good enough.
